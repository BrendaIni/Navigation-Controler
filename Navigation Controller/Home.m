...
//
//  Created by Brenda Iñiguez on 7/23/16.
...
//-------------------------------------------------------------------------------
- (void)initController {
    self.destinationTitles          = [[NSMutableArray alloc] initWithObjects: @"Michoacan", @"Jalisco", @"San Luis Potosí", @"Chiapas", @"Sinaloa", nil];
    self.destinationPhotos          = [[NSMutableArray alloc] initWithObjects: @"Michoacan.jpg", @"Jalisco.jpg", @"SanLuis.jpg", @"Chiapas.jpeg", @"Sinaloa.jpeg", nil];
    self.destinationDescriptions   = [[NSMutableArray alloc] initWithObjects: @"Ven y visita los lagos y maravillas naturales", @"Disfruta del delicioso tequila elaborado en este estado", @"Para los que aman el ecoturismo, es un exelente destino", @"Conoce la comida y la gente únicos de este lugar", @"Conoce las playas y aventuras que tenemos para ti", nil];
}
/**********************************************************************************************/
